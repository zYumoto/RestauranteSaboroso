...
module.exports = function (io) {
  ...
  router.post("/contacts", function (req, res, next) {
    ...
    else if (!req.body.message) contacts.render(req, res, "Digite a menssagem");
    else {
      contacts
        .save(req.body)
        .then((results) => {
  ...
  router.post("/reservations", function (req, res, next) {
    if (!req.body) reservations.render(req, res, "Digite o nome");
    else if (!req.body.email) reservations.render(req, res, "Digite o email");
    else if (!req.body.people)
      reservations.render(req, res, "Digite a quantidade de pessoas");
    else if (!req.body.date) reservations.render(req, res, "Selecione a data");
